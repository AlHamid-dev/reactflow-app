...
const CanvasButtons = ({ toggleMiniMap, isMiniMap, openModal }) => {
    ...
    return (
        <div className="d-flex justify-content-start gap-2">
            ...
            <button className='btn btn-primary' onClick={(e) => openModal(e.target.innerText)} >Add Node</button>
            <button className='btn btn-primary' onClick={(e) => openModal(e.target.innerText)} >Update Node</button>
        </div>
    )
}
